...
class PthreadOwner final {
 public:
  ...
  [[nodiscard]] int start(void *(*entry)(void *), void *argument) noexcept;
  [[nodiscard]] int join(void **result = nullptr) noexcept;
  [[nodiscard]] bool joinable() const noexcept { return started_ && !joined_; }
...
class ChildProcess final {
 public:
  ...
  explicit constexpr ChildProcess(pid_t pid) noexcept : pid_(pid) {}
