...
/* Owns the victim protocol pipe ends and the child pid for one W2/W3 chain.
 *
 * Scope exit never kills the child: a rooted victim that reads EOF finishes
 ...
 * The child side closes its inherited unused ends before child_main runs. */
