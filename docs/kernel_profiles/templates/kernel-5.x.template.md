...
Template JSON: [kernel-5.x.template.json](../../../app/src/main/assets/kernel_profiles/templates/kernel-5.x.template.json). This file contains every field and has no shared-field dependency.
