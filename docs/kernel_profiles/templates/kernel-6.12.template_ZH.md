...
模板 JSON：[kernel-6.12.template.json](../../../app/src/main/assets/kernel_profiles/templates/kernel-6.12.template.json)。本文包含全部字段，不依赖共有字段说明。
...
<tr><td><code>release</code></td><td><code>&lt;exact-uname-r-for-6.12&gt;</code></td><td>定义 6.12 攻击路线消费的 <code>release</code> 配置值。</td></tr>
<tr><td><code>kernel_major</code></td><td><code>6</code></td><td>定义 6.12 攻击路线消费的 <code>kernel_major</code> 配置值。</td></tr>
<tr><th rowspan="15">task_struct 结构偏移</th><td><code>task_prio</code></td><td><code>148</code></td><td>定义 6.12 攻击路线消费的 <code>task_prio</code> 配置值。</td><td rowspan="15">错误值会改变目标选择、结构边界或竞态时序，可能导致失败、死锁、内存破坏、黑屏或重启。</td><td rowspan="15">该值保持 6.12 已验证基线，但不是稳定 ABI；新设备必须用同一目标镜像逐项复核。</td></tr>
<tr><td><code>task_normal_prio</code></td><td><code>156</code></td><td>定义 6.12 攻击路线消费的 <code>task_normal_prio</code> 配置值。</td></tr>
<tr><td><code>task_sched_task_group</code></td><td><code>1056</code></td><td>定义 6.12 攻击路线消费的 <code>task_sched_task_group</code> 配置值。</td></tr>
<tr><td><code>task_pi_lock</code></td><td><code>2540</code></td><td>定义 6.12 攻击路线消费的 <code>task_pi_lock</code> 配置值。</td></tr>
<tr><td><code>task_pi_waiters</code></td><td><code>2560</code></td><td>定义 6.12 攻击路线消费的 <code>task_pi_waiters</code> 配置值。</td></tr>
<tr><td><code>task_pi_top_task</code></td><td><code>2576</code></td><td>定义 6.12 攻击路线消费的 <code>task_pi_top_task</code> 配置值。</td></tr>
<tr><td><code>task_pi_blocked_on</code></td><td><code>2584</code></td><td>定义 6.12 攻击路线消费的 <code>task_pi_blocked_on</code> 配置值。</td></tr>
<tr><td><code>task_pid</code></td><td><code>1800</code></td><td>定义 6.12 攻击路线消费的 <code>task_pid</code> 配置值。</td></tr>
<tr><td><code>task_tgid</code></td><td><code>1804</code></td><td>定义 6.12 攻击路线消费的 <code>task_tgid</code> 配置值。</td></tr>
<tr><td><code>task_atomic_flags</code></td><td><code>1736</code></td><td>定义 6.12 攻击路线消费的 <code>task_atomic_flags</code> 配置值。</td></tr>
<tr><td><code>task_real_cred</code></td><td><code>2296</code></td><td>定义 6.12 攻击路线消费的 <code>task_real_cred</code> 配置值。</td></tr>
<tr><td><code>task_cred</code></td><td><code>2304</code></td><td>定义 6.12 攻击路线消费的 <code>task_cred</code> 配置值。</td></tr>
<tr><td><code>task_comm</code></td><td><code>2320</code></td><td>定义 6.12 攻击路线消费的 <code>task_comm</code> 配置值。</td></tr>
<tr><td><code>task_tasks</code></td><td><code>1592</code></td><td>定义 6.12 攻击路线消费的 <code>task_tasks</code> 配置值。</td></tr>
<tr><td><code>task_seccomp</code></td><td><code>2504</code></td><td>定义 6.12 攻击路线消费的 <code>task_seccomp</code> 配置值。</td></tr>
...
<tr><td><code>pselect_waiter_shift</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>pselect_waiter_shift</code> 配置值。</td></tr>
<tr><th rowspan="9">内核相对符号</th><td><code>off_init_task</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_init_task</code> 配置值。</td><td rowspan="9">错误值会改变目标选择、结构边界或竞态时序，可能导致失败、死锁、内存破坏、黑屏或重启。</td><td rowspan="9">该值保持 6.12 已验证基线，但不是稳定 ABI；新设备必须用同一目标镜像逐项复核。</td></tr>
<tr><td><code>off_init_cred</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_init_cred</code> 配置值。</td></tr>
<tr><td><code>off_root_task_group</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_root_task_group</code> 配置值。</td></tr>
<tr><td><code>off_selinux_enforcing</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_selinux_enforcing</code> 配置值。</td></tr>
<tr><td><code>off_selinux_blob_sizes</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_selinux_blob_sizes</code> 配置值。</td></tr>
<tr><td><code>off_security_hook_heads</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_security_hook_heads</code> 配置值。</td></tr>
<tr><td><code>off_slide_nfulnl_logger</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_slide_nfulnl_logger</code> 配置值。</td></tr>
<tr><td><code>off_slide_boot_id</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_slide_boot_id</code> 配置值。</td></tr>
<tr><td><code>off_slide_loggers_0_1</code></td><td><code>0</code></td><td>定义 6.12 攻击路线消费的 <code>off_slide_loggers_0_1</code> 配置值。</td></tr>
